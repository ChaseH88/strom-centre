...
function (_Component) {
  ...
  function FormBuilderInput() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "addRequired", function (e) {
      _this.setState({
        properties: {
          required: parseJSON(e.target.value)
        }
      });

      console.log(_this.state.properties.required);
    });
...
//# sourceMappingURL=formBuilder.js.6f61dfc5b94e24f86548.hot-update.js.map