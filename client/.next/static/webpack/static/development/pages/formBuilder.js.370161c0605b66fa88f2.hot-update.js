...
function (_Component) {
  ...
  function FormBuilder() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "onDrop", function (e, added) {
      var id = e.dataTransfer.getData("id"); // Update the inputs object with new drop data

      var inputs = _this.state.formElements.filter(function (elem) {
        console.log(_typeof(elem.id));
...
//# sourceMappingURL=formBuilder.js.370161c0605b66fa88f2.hot-update.js.map