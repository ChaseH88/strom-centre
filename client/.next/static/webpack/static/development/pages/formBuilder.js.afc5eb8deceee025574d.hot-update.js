    ...
    value: function render() {
      ...
      this.state.formElements.forEach(function (elem) {
        ...
        if (elem.added == false) {
          ...
          // Create the element
          var element = react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(elem.name, "test");
          inputs[elem.added].push(react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
            onDragStart: function onDragStart(e) {
              return _this2.onDragStart(e, elem.id);
            },
...
//# sourceMappingURL=formBuilder.js.afc5eb8deceee025574d.hot-update.js.map