...
function (_Component) {
  ...
  function FormBuilder() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "rightClick", function (e) {
      e.preventDefault();
      alert("test");
    });
  ...
  _createClass(FormBuilder, [{
    ...
    value: function render() {
      ...
      removeCharacters = function removeCharacters(name) {
        var n = name.toLocaleLowerCase() + elem.order;
...
//# sourceMappingURL=formBuilder.js.5dad4b06c33910640c81.hot-update.js.map